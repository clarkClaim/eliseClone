# mrs-scheduling-interface Specification

## Purpose

Defines how MRS adapters declare and implement scheduling capabilities, supporting both appointment-based (Bahmni) and slot-based MRS systems.
