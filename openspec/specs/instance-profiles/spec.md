# instance-profiles Specification

## Purpose

Profile-based configuration system for running multiple Elise instances, each connecting to a different MRS (OpenMRS, OpenEMR, etc.).
