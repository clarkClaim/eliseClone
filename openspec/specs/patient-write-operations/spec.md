# patient-write-operations Specification

## Purpose

Defines capabilities for creating patients via the MRS adapter and tracking sync status.
...
- **THEN** the adapter generates a valid Luhn Mod-30 identifier (7 characters)
