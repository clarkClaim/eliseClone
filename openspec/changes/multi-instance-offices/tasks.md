...
- [ ] 1.4 Claim second static ngrok domain for EMR profile (MANUAL: go to ngrok dashboard)

## 2. Environment Setup

- [ ] 2.1 Update `.env.example` to include PROFILE= with description of valid values (mrs, emr) (MANUAL: see instructions above)
- [ ] 2.2 Update `.env.example` to reference profile-specific config location (MANUAL: see instructions above)
